    ...
    <div className="flex h-full w-full flex-col items-center justify-center">
      ...
      <div className="flex h-full w-full flex-1 flex-col items-center justify-center">
        <input
          ...
          className="block w-10/12 rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-center text-2xl text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500"
          onChange={(e) => {
